...
return [
    'modules' => [
        ...
        'AJH_Catalog' => 1,
        'AJH_Customer' => 1,
        'AJH_Customerfields' => 1,
        'AJH_D2R' => 1,
        'AJH_ExtendMageContact' => 1,
        'AJH_Fitment' => 1,
        'AJH_Forms' => 1,
        'AJH_InvoiceProcessor' => 0,
        'AJH_LabelImages' => 1,
        'AJH_Orderbysku' => 1,
        'AJH_ProductVehicle' => 1,
        'AJH_SalesOrder' => 1,
        'AJH_Search' => 1,
        'AJH_ShippingBox' => 1,
        'Amasty_Base' => 1,
        ...
        'Amasty_Checkout' => 1,
        'Amasty_ExportPro' => 0,
        'Amasty_InventoryExportEntity' => 0,
        'Amasty_InvisibleCaptcha' => 1,
        'Amasty_Meta' => 1,
        'Amasty_Methods' => 1,
        'Amasty_Number' => 1,
        'Amasty_ProductExportEntity' => 0,
        'Amasty_ProductExport' => 0,
        ...
        'Klarna_Kp' => 1,
        'LitExtension_MigrationToMagento' => 0,
        ...
        'Zemez_FeaturedProduct' => 0,
        'Zemez_FilmSlider' => 1,
        'Zemez_GoogleMap' => 1,
        'Zemez_ThemeOptions' => 0,
        'Zemez_Megamenu' => 1,
        'Zemez_NewsletterPopup' => 0,
        'Zemez_ProductLabels' => 1,
        'Zemez_SampleDataInstaller' => 1,
        'Zemez_ShopByBrand' => 1,
        'Zemez_SiteMaintenance' => 0,
        'Zemez_LayoutSwitcher' => 0
    ]
];
