...
class Main extends Generic implements TabInterface
{
    ...
    protected function _prepareLayout()
    {
        \Magento\Framework\Data\Form::setFieldsetRenderer(
            $this->getLayout()->createBlock(
                'Zemez\FilmSlider\Block\Adminhtml\Renderer\FieldsetAccordion',
    ...
    protected function _prepareForm()
    {
         ...
         */
        if ($this->_isAllowedAction('Zemez_FilmSlider::filmslider_save')) {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'label' => __('CSS Class'),
                'title' => __('CSS Class'),
                'after_element_html' => __('Sets the css class for slider.'),
                'disabled' => $isElementDisabled
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                ...
                'after_element_html' => __('Sets the image background for slider.'),
                'disabled' => $isElementDisabled
            ]
        );

        $image =  $this->getLayout()->createBlock(
            'Zemez\FilmSlider\Block\Adminhtml\SliderItem\Widget\Render\SliderItem\Image',
