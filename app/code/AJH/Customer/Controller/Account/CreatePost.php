...
namespace AJH\Customer\Controller\Account;
...
class CreatePost extends AbstractAccount implements CsrfAwareActionInterface, HttpPostActionInterface {
    ...
    Context $context, Session $customerSession,
            ...
            FormFactory $formFactory, SubscriberFactory $subscriberFactory,
            RegionInterfaceFactory $regionDataFactory,
            AddressInterfaceFactory $addressDataFactory,
            CustomerInterfaceFactory $customerDataFactory,
            CustomerUrl $customerUrl, Registration $registration,
            Escaper $escaper, CustomerExtractor $customerExtractor,
    ...
    protected function extractAddress() {
        ...
        $this->dataObjectHelper->populateWithArray(
                $addressDataObject, $addressData, \Magento\Customer\Api\Data\AddressInterface::class
        );
...
return null;
    ...
    public function execute() {
        ...
        try {
            ...
            $customer->setEmail($this->_request->getParam('email'));                        
