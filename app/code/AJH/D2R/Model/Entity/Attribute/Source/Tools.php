 ...
 */
namespace AJH\D2R\Model\Entity\Attribute\Source;

/**
 * @api
 * @since 100.0.2
 */
class Tools extends \Magento\Eav\Model\Entity\Attribute\Source\AbstractSource
{
    /**
     * Option values
     */
...
//    const VALUE_NO = 0;
    ...
    public function getAllOptions()
    {
        if ($this->_options === null) {
            $this->_options = [
                ['label' => __('PDQ'), 'value' => self::PDQ],
                ['label' => __('ATEQ'), 'value' => self::ATEQ],
                ['label' => __('BARTEC'), 'value' => self::BARTEC],
                ['label' => __('OTHER'), 'value' => self::OTHER],
            ];
        }
